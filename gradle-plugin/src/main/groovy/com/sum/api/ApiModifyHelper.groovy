...
class ApiModifyHelper {
    ...
    //ApiFinder Class类路径
    private static final String API_FINDER_CLASS = "com/zhoupu/router/api/ApiFinder"
    public static final String API_FINDER_CLASS_PATH = API_FINDER_CLASS.replace(".", File.separator) + ".class"
